    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="/" class="logo">
          ...
          <span class="logo-lg"><b>HongJun</b> PROJECT</span>
        </a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="/resources/dist/img/hongjun.jpg" class="user-image" alt="User Image"/>
                  <span class="hidden-xs">Hongjun portfolio</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="/resources/dist/img/hongjun.jpg" class="img-circle" alt="User Image" />
                    <p>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              <a href="#">
                <i class="fa fa-edit"></i> <span>Smart Board</span>
