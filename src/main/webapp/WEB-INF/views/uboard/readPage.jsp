			...
			<div class="box box-success">
				...
				<div class="box-body">
					<label for="exampleInputEmail1">Writer</label> <input
						class="form-control" type="text" placeholder="USER ID" id="newReplyWriter"> 
...
$(document).ready(function(){
	...
	$("#modifyBtn").on("click", function(){
		formObj.attr("action", "/uboard/modifyPage");
	...
	$("#removeBtn").on("click", function(){
		...
		formObj.attr("action", "/uboard/removePage");
		formObj.submit();
	});	
	
	$("#goListBtn ").on("click", function(){
		formObj.attr("method", "get");
		formObj.attr("action", "/uboard/list");
		formObj.submit();
	});
	...
	$.getJSON("/uboard/getAttach/"+bno,function(list){
		$(list).each(function(){
